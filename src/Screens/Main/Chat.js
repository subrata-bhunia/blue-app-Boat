            ...
            <CustomHeader 
             ...
             <View style={sb.SEC2}>
               <View style={{marginTop:30,padding:10}}>
                   ...
                   <View style={{width:"85%",marginLeft:7,backgroundColor:"rgba(0, 0, 0, 0.03)",padding:20,borderRadius:12}}>
                   ...
                   {/* <Image style={{height:30,width:30,borderRadius:7}} source={{uri:PriScrData.avtar}} /> */}
                   <View style={{width:"85%",marginLeft:7,backgroundColor:"rgba(10, 132, 129, 0.12)",padding:20,borderRadius:12}}>
                       <Text style={{fontFamily:FontFamily.default,fontSize:12}}>
